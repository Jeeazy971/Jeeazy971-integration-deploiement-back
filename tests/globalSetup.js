...
// Chargez les variables d'environnement depuis .env.test
dotenv.config({ path: path.resolve(__dirname, "../.env.test") });
console.log(`Chargement des variables d'environnement depuis .env.test`);
...
module.exports = async () => {
    ...
    // Déconnexion pour permettre aux tests de se reconnecter proprement
